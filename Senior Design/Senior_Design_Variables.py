...
# I just took out the stroke lengths that we definitely would never use (1-8, 23-40)
actuator_limits = [[16.87, 25.87], [17.87, 27.87], [19.87, 31.87], [21.87, 25.87], [23.87, 39.87], [25.87, 43.87],
                       [27.87, 47.87]]
...
work_space = [19, 19]
work_space_origin = [26, -18]

ground_positions_range = [18, 40]
